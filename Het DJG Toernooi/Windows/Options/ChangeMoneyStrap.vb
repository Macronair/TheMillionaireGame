Public Class ChangeMoneyStrap
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        If chkGold.Checked = True Then
            TVControlPnl.pnlStrap.BackgroundImage = My.Resources.winning_0
            TVControlPnl.lblAmount.ForeColor = Color.Black
        ElseIf chkGreen.Checked = True Then
            TVControlPnl.pnlStrap.BackgroundImage = My.Resources.winning_1
            TVControlPnl.lblAmount.ForeColor = Color.Black
        ElseIf chkDark.Checked = True Then
            TVControlPnl.pnlStrap.BackgroundImage = My.Resources.winning_2
