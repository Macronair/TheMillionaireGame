...
Public Class OptionsSelectSound
    ...
    Private Sub AddDirectoriesAndFiles(parentNode As TreeNode, loc As String)
        Try
            ...
            For Each file As String In files
                ...
                If file.Contains(".mp3") Or file.Contains(".wav") Or file.Contains(".flac") Or file.Contains(".mpeg") Or file.Contains(".ogg") Then
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        If txtSelectedFile.Text.EndsWith(".mp3") Or txtSelectedFile.Text.EndsWith(".wav") Or txtSelectedFile.Text.EndsWith(".mpeg") Or txtSelectedFile.Text.EndsWith(".flac") Or txtSelectedFile.Text.EndsWith(".ogg") Then
